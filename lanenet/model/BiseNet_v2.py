...
class BinarySegmentationBranch(nn.Module):
    ...
    def __init__(self):
        ...
        self.bsconv1_pre = conv2d(128,256,3,1,1,use_rl=True)
        self.bsconv1_pre1 = conv2d(256,256,3,1,1,use_rl=True)
        self.bsconv1_pre2 = conv2d(352,256,3,1,1,use_rl=True)
        self.bsconv1_pre3 = conv2d(256,256,3,1,1,use_rl=True)
        self.bsconv1_pre4 = conv2d(320,256,3,1,1,use_rl=True)
        self.bsconv1_pre5 = conv2d(256,128,3,1,1,use_rl=True)
