...
if __name__ == '__main__':
    ...
    print(model)
    output = model(input)
    binary_seg_pred=output["binary_seg_pred"].squeeze(0)
    binary_seg_pred=binary_seg_pred.squeeze(0)

    instance_seg_logits=output["instance_seg_logits"].squeeze(0)
    instance_seg_logits=instance_seg_logits.permute(1, 2, 0)

    print('+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
    print('BiSeNet_v2', binary_seg_pred.size())
    print('BiSeNet_v2', instance_seg_logits.size())
    print('+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
